            ...
            <section id="Sidebar" class="flex flex-col w-[420px] gap-8">
                ...
                <div class="flex flex-col rounded-3xl pt-8 gap-6 bg-white">
                    ...
                    <div class="flex flex-col">
                        <a href="{{route('front.booking', $workshop->slug)}}" class="flex items-center justify-center mx-8 h-16 rounded-xl px-6 gap-[10px] 
                        bg-aktiv-orange font-semibold text-lg leading-[27px] text-white mb-8">Join Workshop</a>
                    </div>
                </div>
            </section>
        </main>
