    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <a href="{{ route('front.details', $itemNewWorkshop->slug) }}" class="card">
                <div class="flex items-center h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        <div class="flex item-center gap-3">
                            <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                    <img src="{{ Storage::url($itemNewWorkshop->instructor->avatar) }}" class="w-full h-full object-cover" alt="icon">
                </div>
                ...
                <div class="card-detail flex flex-col gap-2">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-1">
                            <img src="{{asset('assets/images/icons/timer-2.svg')}}" class="w-6 h-6 flex shrink-0" alt="icon">
